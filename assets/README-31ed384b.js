import{o as a,a as t,z as n}from"./vue-libs-56ed11d2.js";const e={class:"van-doc-markdown-body"},l=n(`<h1>Switch</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used to switch between open and closed states.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
</code></pre></div><h2 id="api" tabindex="-1">API</h2><div class="van-doc-card"><h3 id="props" tabindex="-1">Props</h3><table><thead><tr><th>Attribute</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td>v-model</td><td>Check status of Switch</td><td><em>ActiveValue | InactiveValue</em></td><td><code>false</code></td></tr><tr><td>loading</td><td>Whether to show loading icon</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>disabled</td><td>Whether to disable switch</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td>size</td><td>Size of switch button</td><td><em>number | string</em></td><td><code>26px</code></td></tr><tr><td>active-color</td><td>Background color when active</td><td><em>string</em></td><td><code>#1989fa</code></td></tr><tr><td>inactive-color</td><td>Background color when inactive</td><td><em>string</em></td><td><code>rgba(120, 120, 128, 0.16)</code></td></tr><tr><td>active-value</td><td>Value when active</td><td><em>any</em></td><td><code>true</code></td></tr><tr><td>inactive-value</td><td>Value when inactive</td><td><em>any</em></td><td><code>false</code></td></tr></tbody></table></div><div class="van-doc-card"><h3 id="events" tabindex="-1">Events</h3><table><thead><tr><th>Event</th><th>Description</th><th>Parameters</th></tr></thead><tbody><tr><td>change</td><td>Emitted when check status changed</td><td><em>value: any</em></td></tr><tr><td>click</td><td>Emitted when component is clicked</td><td><em>event: MouseEvent</em></td></tr></tbody></table></div><div class="van-doc-card"><h3 id="slots" tabindex="-1">Slots</h3><table><thead><tr><th>Name</th><th>Description</th><th>SlotProps</th></tr></thead><tbody><tr><td>node</td><td>Custom the content of node</td><td>-</td></tr><tr><td>background</td><td>Custom the background of switch</td><td>-</td></tr></tbody></table></div><div class="van-doc-card"><h3 id="types" tabindex="-1">Types</h3><p>The component exports the following type definitions:</p><pre><code class="language-ts"><span class="hljs-keyword">import</span> <span class="hljs-keyword">type</span> { <span class="hljs-title class_">SwitchProps</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vant&#39;</span>;
</code></pre></div><h2 id="theming" tabindex="-1">Theming</h2><div class="van-doc-card"><h3 id="css-variables" tabindex="-1">CSS Variables</h3><p>The component provides the following CSS variables, which can be used to customize styles. Please refer to <a href="#/en-US/config-provider" target="_blank">ConfigProvider component</a>.</p><table><thead><tr><th>Name</th><th>Default Value</th><th>Description</th></tr></thead><tbody><tr><td>--van-switch-size</td><td><em>26px</em></td><td>-</td></tr><tr><td>--van-switch-width</td><td><em>calc(1.8em + 4px)</em></td><td>-</td></tr><tr><td>--van-switch-height</td><td><em>calc(1em + 4px)</em></td><td>-</td></tr><tr><td>--van-switch-node-size</td><td><em>1em</em></td><td>-</td></tr><tr><td>--van-switch-node-background</td><td><em>var(--van-white)</em></td><td>-</td></tr><tr><td>--van-switch-node-shadow</td><td><em>0 3px 1px 0 rgba(0, 0, 0, 0.05)</em></td><td>-</td></tr><tr><td>--van-switch-background</td><td><em>rgba(120, 120, 128, 0.16)</em></td><td>-</td></tr><tr><td>--van-switch-on-background</td><td><em>var(--van-primary-color)</em></td><td>-</td></tr><tr><td>--van-switch-duration</td><td><em>var(--van-duration-base)</em></td><td>-</td></tr><tr><td>--van-switch-disabled-opacity</td><td><em>var(--van-disabled-opacity)</em></td><td>-</td></tr></tbody></table></div>`,19),c=[l],i={__name:"README",setup(d,{expose:s}){return s({frontmatter:{}}),(o,r)=>(a(),t("div",e,c))}};export{i as default};
