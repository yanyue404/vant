import{o as a,a as t,z as n}from"./vue-libs-56ed11d2.js";const e={class:"van-doc-markdown-body"},l=n(`<h1>TextEllipsis</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Display ellipsis for long text and support for expanding or collapsing text. Please upgrade to &gt;= v4.1.0 before using this component.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
