...
<span class="hljs-tag">&lt;/<span class="hljs-name">transition</span>&gt;</span>
</code></pre></div><div class="van-doc-card"><h3 id="haptics-feedback" tabindex="-1">Haptics Feedback</h3><p>Add haptics feedback for an element. When touched, the opacity of the element is reduced.</p><p>Usually used in clickable elements such as button.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;van-haptics-feedback&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
</code></pre></div><div class="van-doc-card"><h3 id="clearfix" tabindex="-1">Clearfix</h3><p>Clear floated content within a container.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;van-clearfix&quot;</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
</code></pre></div>`,8),e=[p],j={__name:"README",setup(c,{expose:s}){return s({frontmatter:{}}),(i,o)=>(a(),n("div",t,e))}};export{j as default};
