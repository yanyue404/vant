...
</code></pre></div><h2 id="zhu-ti-ding-zhi" tabindex="-1">主题定制</h2><div class="van-doc-card"><h3 id="yang-shi-bian-liang" tabindex="-1">样式变量</h3><p>组件提供了下列 CSS 变量，可用于自定义样式，使用方法请参考 <a href="#/zh-CN/config-provider" target="_blank">ConfigProvider 组件</a>。</p><table><thead><tr><th>名称</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td>--van-radio-size</td><td><em>20px</em></td><td>-</td></tr><tr><td>--van-radio-border-color</td><td><em>var(--van-gray-5)</em></td><td>-</td></tr><tr><td>--van-radio-duration</td><td><em>var(--van-duration-fast)</em></td><td>-</td></tr><tr><td>--van-radio-label-margin</td><td><em>var(--van-padding-xs)</em></td><td>-</td></tr><tr><td>--van-radio-label-color</td><td><em>var(--van-text-color)</em></td><td>-</td></tr><tr><td>--van-radio-checked-icon-color</td><td><em>var(--van-primary-color)</em></td><td>-</td></tr><tr><td>--van-radio-disabled-icon-color</td><td><em>var(--van-gray-5)</em></td><td>-</td></tr><tr><td>--van-radio-disabled-label-color</td><td><em>var(--van-text-color-3)</em></td><td>-</td></tr><tr><td>--van-radio-disabled-background</td><td><em>var(--van-border-color)</em></td><td>-</td></tr></tbody></table></div>`,23),c=[p],i={__name:"README.zh-CN",setup(d,{expose:s}){return s({frontmatter:{}}),(o,h)=>(a(),n("div",l,c))}};export{i as default};
