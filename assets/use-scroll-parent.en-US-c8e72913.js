import{o as a,a as t,z as n}from"./vue-libs-56ed11d2.js";const e={class:"van-doc-markdown-body"},l=n(`<h1>useScrollParent</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Get the closest parent element that is scrollable.</p></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">ref</span>=<span class="hljs-string">&quot;root&quot;</span> /&gt;</span>
