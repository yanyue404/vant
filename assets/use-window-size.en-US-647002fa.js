import{o as a,a as n,z as t}from"./vue-libs-56ed11d2.js";const e={class:"van-doc-markdown-body"},l=t(`<h1>useWindowSize</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Get the viewport width and height of the browser window, and update it automatically when the window size changes.</p></div><h2 id="usage" tabindex="-1">Usage</h2><div class="van-doc-card"><h3 id="basic-usage" tabindex="-1">Basic Usage</h3><pre><code class="language-js"><span class="hljs-keyword">import</span> { watch } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
