...
</code></pre></div><h2 id="zhu-ti-ding-zhi" tabindex="-1">主题定制</h2><div class="van-doc-card"><h3 id="yang-shi-bian-liang" tabindex="-1">样式变量</h3><p>组件提供了下列 CSS 变量，可用于自定义样式，使用方法请参考 <a href="#/zh-CN/config-provider" target="_blank">ConfigProvider 组件</a>。</p><table><thead><tr><th>名称</th><th>默认值</th><th>描述</th></tr></thead><tbody><tr><td>--van-contact-edit-padding</td><td><em>var(--van-padding-md)</em></td><td>-</td></tr><tr><td>--van-contact-edit-fields-radius</td><td><em>var(--van-radius-md)</em></td><td>-</td></tr><tr><td>--van-contact-edit-buttons-padding</td><td><em>var(--van-padding-xl) 0</em></td><td>-</td></tr><tr><td>--van-contact-edit-button-margin-bottom</td><td><em>var(--van-padding-sm)</em></td><td>-</td></tr><tr><td>--van-contact-edit-button-font-size</td><td><em>var(--van-font-size-lg)</em></td><td>-</td></tr><tr><td>--van-contact-edit-field-label-width</td><td><em>4.1em</em></td><td>-</td></tr></tbody></table></div>`,12),l=[e],h={__name:"README.zh-CN",setup(c,{expose:t}){return t({frontmatter:{}}),(p,r)=>(s(),a("div",d,l))}};export{h as default};
