...
</code></pre><p>Vant 从 4.0 版本开始不再支持 <code>babel-plugin-import</code> 插件，请参考 <a href="#/zh-CN/migrate-from-v3#yi-chu-babel-plugin-import" target="_blank">迁移指南</a> 移除该插件。</p></div>`,17),l=[e],h={__name:"README.zh-CN",setup(o,{expose:s}){return s({frontmatter:{}}),(c,i)=>(a(),t("div",d,l))}};export{h as default};
