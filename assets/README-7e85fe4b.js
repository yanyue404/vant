import{o as a,a as n,z as l}from"./vue-libs-56ed11d2.js";const t={class:"van-doc-markdown-body"},p=l(`<h1>Form</h1><div class="van-doc-card"><h3 id="intro" tabindex="-1">Intro</h3><p>Used for data entry and verification, and supports input boxes, radio buttons, check boxes, file uploads and other types. Should be used with <a href="#/en-US/field" target="_blank">Field</a> component.</p></div><div class="van-doc-card"><h3 id="install" tabindex="-1">Install</h3><p>Register component globally via <code>app.use</code>, refer to <a href="#/en-US/advanced-usage#zu-jian-zhu-ce" target="_blank">Component Registration</a> for more registration ways.</p><pre><code class="language-js"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>;
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  <span class="hljs-title function_">setup</span>(<span class="hljs-params"></span>) {
    ...
    <span class="hljs-keyword">const</span> columns = [
      ...
      { <span class="hljs-attr">text</span>: <span class="hljs-string">&#39;Georqia&#39;</span>, <span class="hljs-attr">value</span>: <span class="hljs-string">&#39;Georqia&#39;</span> },
...
</code></pre></div><div class="van-doc-card"><h3 id="field-type---datepicker" tabindex="-1">Field Type - DatePicker</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">van-field</span>
  <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;result&quot;</span>
  <span class="hljs-attr">is-link</span>
  <span class="hljs-attr">readonly</span>
